...
CREATE TABLE `cotizacion_has_material` (
  ...
  CONSTRAINT `fk_Cotizacion_has_Material1_Cotizacion1` FOREIGN KEY (`Cotizacion_idCotizacion`) REFERENCES `cotizacion` (`idCotizacion`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
INSERT INTO `empleado` VALUES (2,'JUAN','RAMIREZ','MORA','6873456598','AVENIDA','juanrape@correoimaginario.com','ASDKJ12389ASDK',1);
...
INSERT INTO `prospecto` VALUES (2,'ISELA','PRIETO','PARADA','123243','a6@a.com'),(3,'ISELA','PRIETO','PARADA','123243','a6@a.com'),(4,'ISELA','PRIETO','PARADA','123243','a6@a.com'),(5,'ISELA','PRIETO','PARADA','123243','a6@a.com'),(6,'ISELA','PRIETO','PARADA','123243','a6@a.com'),(7,'ISELA','PRIETO','SENTADA','123243','a6@a.com'),(8,'ISELA','PRIETO','PARADA','123243','a6@a.com'),(9,'ISELA','PRIETO','PARADA','123243','a6@a.com'),(10,'ISELA','PRIETO','PARADA','123243','a6@a.com'),(11,'PAULO','COHELO','PARADA','123243','a6@a.com');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `ultima_cotizacion` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `ultima_cotizacion`() RETURNS int(11)
BEGIN
declare cotid int;
...
in Concepto_Cotizacion varchar(45), in distancia_trabajo int,
in tiempoServicio int,in tipoPago int,in idCliente int)
BEGIN
	insert into cotizacion (concepto,distancia,tiempo_servicio,TipoPago_idTipoPago,Cliente_idCliente)
    values(upper(Concepto_Cotizacion),distancia_trabajo ,tiempoServicio,tipoPago,idCliente);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `agregar_cotizacion_material` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `agregar_cotizacion_material`(in idC int, in idMat int, in cant int)
BEGIN

insert into cotizacion_has_material (Cotizacion_idCotizacion,Material_idMaterial,cantidad_material)
    values(idC,idMat,cant);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `eliminar_cotizacion_material` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `eliminar_cotizacion_material`(in idC int, in idM int)
BEGIN
delete from cotizacion_has_material where Cotizacion_idCotizacion = idC 
and Material_idMaterial = idM;
...
BEGIN
	...
	delete from prospecto where idProspecto = idpros;
